    ...
    var aiwaveJs = {
        ...
        slickSliderActivation: function () {
            ...
            $('.rainbow-service-slider-actvation').not('.slick-initialized').slick({
                ...
                dots: true,
                arrows: true,
                prevArrow: '<button class="slide-arrow  prev-arrow  d-none" ><i class="fa-regular fa-arrow-left"></i></button>',
                nextArrow: '<button class="slide-arrow next-arrow  d-none" ><i class="fa-sharp fa-regular fa-arrow-right"></i></button>',
                cssEase: 'linear',
                responsive: [
                    {
                      breakpoint: 1200,
